...
/////////////////////////////////////////////////////////
// 🔑 COLA TUA CHAVE AQUI ENTRE ASPAS
    ...
    <View style={styles.container}>
      {region ? (
        ...
        >
          {chargingStations.map((st) => (
            <Marker
              ...
              title={st.name}
              description={st.address || 'Ponto de recarga elétrica'}
            />
          ))}
        ...
        <View style={styles.loaderContainer}>
          ...
          <Text style={{ color: '#fff', marginTop: 10 }}>Obtendo localização...</Text>
        </View>
      )}
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>📍 Patrocínio: Canal Eletrificados YouTube</Text>
      </View>
    </View>
  );
}
